...
def run_training():
        ...
        with torch.no_grad():
            ...
            if acc > best_acc:
                ...
                torch.save({'iter': i,
                            'model_state_dict': model.state_dict(),
                            'optimizer_state_dict': optimizer.state_dict(), },
                           os.path.join('models/RAF-DB', "best_model_res18.pth"))
                print('Model saved.')
    ...
    predict_df.to_csv('models/predict_res18.csv', header=False)
    target_df.to_csv('models/target_res18.csv', header=False)
