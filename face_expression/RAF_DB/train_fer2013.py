...
def run_training():
        ...
        with torch.no_grad():
            ...
            if acc > best_acc:
                ...
                torch.save({'iter': i,
                            'model_state_dict': model.state_dict(),
                            'optimizer_state_dict': optimizer.state_dict(), },
                           os.path.join('models/FER2013', "best_model.pth"))
                print('Model saved.')
    ...
    predict_df.to_csv('models/predict_fer2013.csv', header=False)
    target_df.to_csv('models/target_fer2013.csv', header=False)
